...
import { ChevronDown, ChevronRight, File, Settings, Calendar, Home, Trash2, Mic, Square, Plus, Search, Pencil, NotebookPen, SearchIcon, X, Upload, PanelLeftClose, PanelLeftOpen, Tag as TagIcon, ListFilter } from 'lucide-react';
